                ...
                <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
                    ...
                    <Col md={4} className="project-card">
                        <ExperienceCards
                            ...
                            description={"As a Security Analytics Intern at Intact Financial Corporation, I developed Power BI dashboards that improved incident response time by 15% and optimized cloud security using SQL and ElasticSearch. I implemented Row-Level Security (RLS) in Power BI to manage role-based data access, reducing access-related issues by 30%. Additionally, I automated reporting processes with advanced Excel formulas (VLOOKUP, INDEX-MATCH, arrays) and VBA macros, improving efficiency by 25% and enhancing data analysis from CSPM, WAF, and CASB tools."}
                        />
                    </Col>
                </Row>
                <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
